        ...
        <div className="flex flex-col items-center gap-12 w-full">
          ...
          <div className="box-border content-stretch flex flex-row gap-16 items-start justify-start p-0">
            ...
            <div className="bg-[#ffffff] box-border content-stretch flex flex-col h-[650px] items-center justify-between p-[32px] relative rounded-3xl shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] shrink-0">
              <div className="box-border content-stretch flex flex-col gap-12 items-start justify-start p-0 relative shrink-0">
                ...
                <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative shrink-0 w-[359px]">
                  ...
                  <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start p-0 relative shrink-0 w-full">
                    ...
                    <div className="box-border content-stretch flex flex-col gap-2 h-20 items-start justify-start p-0 relative shrink-0 w-[359px]">
                      ...
                      <div className="box-border content-stretch flex flex-row gap-1 h-12 items-center justify-start px-2 py-0 relative shrink-0 w-full border-b border-[#bbbbbb]">
                        <input
                          ...
                          className="basis-0 flex flex-col font-['Pretendard:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#bbbbbb] text-[16px] text-right tracking-[-0.48px] bg-transparent border-none outline-none"
                        />
                    ...
                    <div className="box-border content-stretch flex flex-col gap-2 items-start justify-start p-0 relative shrink-0 w-full">
                      ...
                      <div className="box-border content-stretch flex flex-row gap-1 h-12 items-center justify-start px-2 py-0 relative shrink-0 w-full border-b border-[#bbbbbb]">
                        <div className="basis-0 flex flex-col font-['Pretendard:SemiBold',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#bbbbbb] text-[20px] text-right tracking-[-0.6px]">
                ...
                <div className="box-border content-stretch flex flex-col gap-4 items-start justify-start p-0 relative shrink-0 w-[359px]">
                  ...
                  <div className="bg-[#ffffff] box-border content-stretch flex flex-col gap-2.5 h-[62px] items-center justify-center px-5 py-2.5 relative rounded-lg shrink-0 w-full border border-[#bbbbbb]">
                    <div className="bg-[19.67%_50%] bg-no-repeat bg-size-[192.8%_448.72%] h-6 shrink-0 w-[120px] bg-gray-200 rounded flex items-center justify-center">
                      <span className="text-sm text-gray-600">Toss Pay</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Charge Button */}
              <div className="bg-[#f7f7f7] box-border content-stretch flex flex-col gap-2.5 h-[62px] items-center justify-center px-5 py-2.5 relative rounded-lg shrink-0 w-[359px]">
                <div className="box-border content-stretch flex flex-row items-center justify-between p-0 relative shrink-0 w-full">
                  <div className="flex flex-col font-['Pretendard:SemiBold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#bbbbbb] text-[20px] text-center tracking-[-0.6px] w-[245px]">
                    <p className="adjustLetterSpacing block leading-[1.5]">결제하기</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#ffffff] box-border content-stretch flex flex-col h-[650px] gap-12 items-end justify-start p-[32px] relative rounded-3xl shadow-[0px_4px_20px_0px_rgba(0,0,0,0.1)] shrink-0">
                  ...
                  <div className="box-border content-stretch flex flex-col gap-2 h-20 items-start justify-start p-0 relative shrink-0 w-full">
                    <div className="box-border content-stretch flex flex-row items-start justify-between leading-[0] not-italic p-0 relative shrink-0 text-[16px] text-left text-nowrap tracking-[-0.48px] w-[350px]">
                      ...
                      <div className="flex flex-col font-['Pretendard:SemiBold',_sans-serif] justify-center relative shrink-0 text-[#1aa752]">
                        <p className="adjustLetterSpacing block leading-[1.5] text-nowrap whitespace-pre">50,000</p>
                      </div>
                    </div>
              ...
              {/* Exchange Button */}
              <div className="bg-[#f7f7f7] box-border content-stretch flex flex-col gap-2.5 h-[62px] items-center justify-center px-5 py-2.5 relative rounded-lg shrink-0 w-[358px]">
                <div className="box-border content-stretch flex flex-row items-center justify-between p-0 relative shrink-0 w-full">
                  <div className="flex flex-col font-['Pretendard:SemiBold',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#bbbbbb] text-[20px] text-center tracking-[-0.6px] w-[245px]">
                    <p className="adjustLetterSpacing block leading-[1.5]">환전하기</p>
                  </div>
                </div>
              </div>
            </div>
