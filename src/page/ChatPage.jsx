...
export const ChatPage = () => {
  return (
    <div className="flex flex-1 bg-white h-screen my-20">
      {/* 채팅 목록 */}
      <aside className="w-[331px] h-[774px] bg-white m-12 p-6 flex-shrink-0 border rounded">
        <div className="flex items-center gap-4">
          <img src={ChatIcon} alt="chat" className="w-28px h-24px" />
          <h2
            className="mb-4"
      ...
      >
        <div className="flex">
          ...
          <button className=" ml-220 bg-green-500 border-radius-100px px-4 py-2 rounded font-semibold cursor-pointer hover:bg-green-400">
            결제하기
          </button>
        </div>
        {/* 채팅 메시지 예시 */}
