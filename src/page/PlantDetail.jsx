      ...
      <div className="bg-white min-h-screen">
        ...
        <div className="hidden md:block relative w-full min-h-screen">
          ...
          {isMyFarm ? (
            ...
            <div
              className="absolute bg-[#1aa752] box-border content-stretch flex flex-col gap-2.5 items-center justify-center pl-7 pr-6 py-3 rounded-[100px] top-[800px] cursor-pointer"
