...
//       <div className="bg-white w-[500px] rounded-2xl shadow-lg p-8 relative flex flex-col gap-6">
//         {/* 닫기 버튼 */}
//         <button
//           onClick={onClose}
...
//           <div className="relative border border-[#1AA752] rounded-2xl px-8 py-4">
//             <textarea
//               className="w-full font-[Pretendard] text-base text-[#BBB] resize-none focus:outline-none placeholder-[#BBB] leading-[150%] tracking-[-0.48px] pr-24 pb-10"
...
//               <span className="text-[#1AA752] font-[Pretendard] text-sm font-normal leading-[150%] tracking-[-0.48px]">
//                 친환경 점수 +10
//               </span>
