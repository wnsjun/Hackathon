...
const CheckSquareContained = ({ check = "off" }) => {
  if (check === "off") {
    return (
      <div className="relative size-full flex items-center justify-center" data-name="check=off">
        <UncheckedIcon />
      </div>
    );
  }
  ...
  return (
    <div className="relative size-full flex items-center justify-center" data-name="check=on">
      <CheckedIcon />
    </div>
  );
};
